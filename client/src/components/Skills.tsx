            ...
            <div className="grid md:grid-cols-2 gap-0 relative">
                ...
                <div className="p-10 bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl hover:border-primary/30 transition-all shadow-xl relative z-20 md:mb-8">
                    <div className="flex justify-between items-baseline mb-4">
                      <h4 className="font-bold text-2xl tracking-tight">Bachelor of Science (BS)</h4>
                      <span className="text-primary font-bold bg-primary/10 px-4 py-1 rounded-full text-xs tracking-wider uppercase">2013-2017</span>
                    </div>
                    <p className="text-xl font-medium mb-1 text-foreground">Software Engineering</p>
                    <p className="text-muted-foreground text-sm uppercase tracking-wider font-light">Lutsk National Technical University (LNTU)</p>
                </div>
            </div>
        </motion.div>
      </div>
